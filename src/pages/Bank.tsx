              ...
              <GlassCard className="mt-4" accentColor="#00E676">
                ...
                <div className="flex items-center gap-3">
                  <input type="number" value={payAmount} onChange={(e) => setPayAmount(Number(e.target.value))}
                    ...
                    min={1} max={Math.min(player.cash, activeLoans.find(l => l.id === selectedLoanId)?.remainingBalance || 0)} />
                  <button onClick={() => { payLoan(selectedLoanId, payAmount); setSelectedLoanId(null); }}
                    disabled={payAmount <= 0 || payAmount > player.cash} className="btn-primary text-xs py-2 px-4 disabled:opacity-50">Pay</button>
                </div>
              </GlassCard>
            )}
          </div>
            ...
            <GlassCard accentColor="#00F0FF">
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input type="range" min={5} max={35} value={loanYears}
