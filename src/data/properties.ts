...
const baseProperties: Property[] = [
  // HDB BTO Properties
  {
    ...
    description: 'Entry-level starter flat near the northern employment corridor. Compact, efficient, and realistic for a first serious move.',
    amenities: ['Community Plaza', 'Covered Linkway', 'Playground', 'Food Centre Nearby'],
  ...
  // HDB Resale Properties
  {
    ...
    rentalYield: 5.5,
    image: '/district-hdb.jpg',
    description: 'A practical starter resale unit with manageable entry pricing and strong rental demand from nearby industrial hubs.',
    amenities: ['Neighborhood Centre', 'Bus Interchange Access', 'Hawker Centre', 'Sports Complex'],
    nearestMrt: 'Jurong West MRT',
    isAvailable: true,
    isHdb: true,
  },
  {
  ...
  // Executive Condo
  {
    ...
    description: 'Modern EC with full condo facilities, strong northern upgrader demand, and a practical walk-to-MRT story.',
  ...
  },
  {
    ...
    rentalYield: 3.9,
    image: '/property-interior-1.jpg',
    description: 'Brand new north-region EC with smart-home fittings, efficient layouts, and affordable upgrader positioning.',
  ...
  },
  {
    ...
    rentalYield: 3.5,
    image: '/property-interior-1.jpg',
    description: 'Premium waterfront-style EC with stronger lifestyle appeal and a longer-term northeast growth story.',
  ...
  // Private Condo
  {
    ...
    description: 'Ultra-luxury Orchard corridor condo with direct-city convenience and premium concierge-style positioning.',
  ...
  },
  {
    ...
    description: 'CBD residence with Marina Bay views, garden-deck amenities, and a deep corporate tenant pool.',
  ...
  },
  {
    ...
    rentalYield: 2.6,
    image: '/property-interior-1.jpg',
    description: 'Luxury Farrer Road condo with lush garden-themed landscaping and quiet prime-district appeal.',
  ...
  },
  {
    ...
    rentalYield: 3.4,
    image: '/property-interior-1.jpg',
    description: 'Prime Bugis compact unit with flexible layouts, strong renter demand, and fast liquidity potential.',
  ...
  },
  {
    ...
    rentalYield: 3.2,
    image: '/property-interior-1.jpg',
    description: 'Distinctive city-fringe tower at Pearl\'s Hill with strong greenery views and rental appeal.',
  ...
  },
  {
    ...
    rentalYield: 2.9,
    image: '/property-interior-1.jpg',
    description: 'Architectural high-rise in prestigious Farrer Road with generous landscaping and family-friendly facilities.',
  ...
  },
  {
    ...
    rentalYield: 3.3,
    image: '/property-interior-1.jpg',
    description: 'Twin-tower city-fringe condo near Queenstown MRT with modern facilities and city views.',
  ...
  },
  {
    ...
    rentalYield: 3.1,
    image: '/property-interior-1.jpg',
    description: 'Tall city-fringe towers near Silat with heritage-neighborhood context and strong CBD access.',
  ...
  },
  {
    ...
    rentalYield: 3.6,
    image: '/property-interior-1.jpg',
    description: 'Large residential project with Kent Ridge Park views and steady education-corridor tenant depth.',
  ...
  },
  {
    ...
    rentalYield: 4.0,
    image: '/property-interior-1.jpg',
    description: 'Mega OCR condo with extensive facilities, entry-level private pricing, and broad family demand.',
